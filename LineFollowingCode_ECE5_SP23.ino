...
// V 3.0
// Last Modified 5/20/2023 by MingWei Yeoh (and Karcher helped)
/* ************************************************************************************************* */
...
#define PRINTALLDATA        1  // Prints ALL the data when changed to 1, Could be useful for debugging =), Turn to 0 when running robot untethered
...
L298NX2 DriveMotors(  5, 3, 7,      6, 2, 4);
